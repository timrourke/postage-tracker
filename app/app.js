...
var app = angular.module('PostageTracker', ['ui.router']);
...
app.factory('transactionsFactory', function() {
	var transactions = [
		{
			id: 1,
			date: new Date(2015, 00, 01),
			jobNumber: 116123,
			description: 'Local 143 SPD mailing',
			salesRep: 'TMS',
			numPieces: 347,
			amount: 105.43
		},{
			id: 2,
			date: new Date(2015, 00, 02),
			jobNumber: 116125,
			description: 'Local 143 SPD mailing - retirees',
			salesRep: 'TMS',
			numPieces: 2154,
			amount: 602.32
		},{
			id: 3,
			date: new Date(2015, 00, 03),
			jobNumber: 116207,
			description: 'DePaul Invite Postcard - Students',
			salesRep: 'TMS',
			numPieces: 804,
			amount: 389.02
		},{
			...
			date: new Date(2015, 00, 03),
			jobNumber: 116206,
			description: 'DePaul Invite Postcard - Teachers',
			salesRep: 'TMS',
			numPieces: 213,
			amount: 104.89
		},{
			id: 5,
			date: new Date(2015, 00, 06),
			jobNumber: 116398,
			description: 'SEIU Home Care AFN',
			salesRep: 'RMW',
			numPieces: 13437,
			amount: 2462.19
		},{
			id: 6,
			date: new Date(2015, 00, 14),
			jobNumber: 116402,
			description: 'BJB Properties Postcard - Lincoln Park',
			salesRep: 'RMW',
			numPieces: 751,
			amount: 423.55
		}
...
app.controller('transactionsController', ['$scope', '$filter', 'transactionsFactory', function($scope, $filter, transactionsFactory) {
	...
	function addTransaction(transaction) {
		transaction.id = $scope.transactions.length;
